                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 space-y-6">
                    ...
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            Join Fulla to publish and manage packages
                        </p>
                    </div>
                    ...
                    <div class="text-center pt-4 border-t border-gray-200 dark:border-slate-700">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <A href="/login" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300 transition-colors">
                                Sign in
                            </A>
                        </p>
                    </div>
